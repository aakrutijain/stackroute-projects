...
public class UserController {
	 ...
	 */
	@PutMapping("/user/{id}")
	public ResponseEntity<?> updateUser(@RequestBody User user, @PathVariable("id") String id, HttpSession httpSession) {
		...
		try {
			...
			return new ResponseEntity<String>("Could not update, please contact admin", HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	public ResponseEntity<?> delete(@PathVariable("id") String id, HttpSession httpSession) {
	...
	@GetMapping("/user/{id}")
	public ResponseEntity<?>  getUser(@PathVariable("id") String id, HttpSession httpSession) {
