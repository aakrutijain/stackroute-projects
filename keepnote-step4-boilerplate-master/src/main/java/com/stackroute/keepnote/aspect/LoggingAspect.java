...
public class LoggingAspect {
	...
	public void logBefore(JoinPoint joinpoint) {
		log.info("Before execution of Advice : "+joinpoint.getSignature().getName());
	}
	
	@After("within(com.stackroute.keepnote..*)")
	public void logAfter(JoinPoint joinpoint) {
		log.info("After execution of Advice : "+joinpoint.getSignature().getName());
	}
	
	@AfterReturning(pointcut="within(com.stackroute.keepnote..*)", returning="result")
	public void logAfterReturning(JoinPoint joinPoint, Object result) {
		log.info("Execution of After Returning Advice : "+joinPoint.getSignature().getName()+" : "+result);
	}
	
	@AfterThrowing(pointcut="within(com.stackroute.keepnote..*)", throwing="error")
	public void logAfterThrowing(JoinPoint joinPoint, Throwable error) {
		log.info("Execution of After throwing Advice : "+joinPoint.getSignature().getName()+" : "+error);
	}
