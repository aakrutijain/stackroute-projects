...
describe('AppComponent', () => {
  ...
  it('should handle 404 error on get notes', fakeAsync(() => {
    ...
    spyGetNotes = spyOn(notesService, 'getNotes').and.returnValue(observableThrowError(errorResponse404));
  ...
  it('should handle 404 error on add note', fakeAsync(() => {
    ...
    spyGetNotes = spyOn(notesService, 'getNotes').and.returnValue(observableOf(positiveResponse));
    spyTakeNotes = spyOn(notesService, 'addNote').and.returnValue(observableThrowError(errorResponse404));
    fixture.detectChanges();
    tick();
  ...
  it('should handle blank fields', fakeAsync(() => {
    ...
    debugElement = fixture.debugElement.query(By.css('.error-message'));
    spyGetNotes = spyOn(notesService, 'getNotes').and.returnValue(observableOf(positiveResponse));
    spyTakeNotes = spyOn(notesService, 'addNote').and.returnValue(observableOf(errorMessage));
    fixture.detectChanges();
  ...
  it('should handle to add a note', fakeAsync(() => {
    ...
    textArea = fixture.debugElement.nativeElement.querySelector('textarea');
    spyGetNotes = spyOn(notesService, 'getNotes').and.returnValue(observableOf(positiveResponse));
    spyTakeNotes = spyOn(notesService, 'addNote').and.returnValue(observableOf(addNotesPositiveResponse));
    fixture.detectChanges();
    tick();
